...
public final class MergeUtils {
    public static void a(String str) {
        throw new com.github.catvod.spider.merge.a1.C0900e(str);
    }
    ...
    public static void g(String str, String str2) {
        if (str == null || str.length() == 0) {
            throw new com.github.catvod.spider.merge.a1.C0900e(str2);
        }
    }
    ...
    public static void i(Object obj, String str) {
        if (obj == null) {
            throw new com.github.catvod.spider.merge.a1.C0900e(String.format("The parameter '%s' must not be null.", str));
        }
    }

    public static String j(com.github.catvod.spider.merge.y.C1416e c1416e) {
        com.github.catvod.spider.merge.y.C1413b c1413bT;
    ...
    public static List k(com.github.catvod.spider.merge.y.C1416e c1416e) {
        com.github.catvod.spider.merge.y.C1413b c1413bT;
        ...
        for (int i = 0; i < c1413bT.size(); i++) {
            com.github.catvod.spider.merge.y.C1416e c1416eO = c1413bT.o(i);
