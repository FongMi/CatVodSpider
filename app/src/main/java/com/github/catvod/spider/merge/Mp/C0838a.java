...
/* JADX INFO: renamed from: com.github.catvod.spider.merge.Mp.a, reason: case insensitive filesystem */
...
public final class C0838a {
    ...
    public C0838a(Reader reader, int i) {
        com.github.catvod.spider.merge.XU.k.c(reader.markSupported());
        this.b = reader;
    ...
    private void b() {
        ...
        try {
            ...
            if (i4 > 0) {
                ...
                com.github.catvod.spider.merge.XU.k.c(z);
                this.c = i4;
                this.f += i;
                this.e = i2;
                if (this.g != -1) {
    ...
    */
    private static java.lang.String c(char[] r9, java.lang.String[] r10, int r11, int r12) {
        ...
        L47:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.Mp.C0838a.c(char[], java.lang.String[], int, int):java.lang.String");
    }
    ...
    final void M() {
        int i = this.g;
        if (i == -1) {
            throw new com.github.catvod.spider.merge.XI.w(new IOException(ZrJ.d("34223926682C17352A212121")));
        }
        this.e = i;
        this.g = -1;
    }
    ...
    final void P() {
        int i = this.e;
        if (i < 1) {
            throw new com.github.catvod.spider.merge.XI.w(new IOException(ZrJ.d("2E170D77680B166329382E231C316B212D230D633F226830172024233B30142665")));
        }
        this.e = i - 1;
    }
    ...
    final String v() {
        return A(this.f + this.e) + ZrJ.d("43") + e(this.f + this.e);
    }
