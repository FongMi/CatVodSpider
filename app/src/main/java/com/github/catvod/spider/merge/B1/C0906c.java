...
/* JADX INFO: renamed from: com.github.catvod.spider.merge.b1.c, reason: case insensitive filesystem */
...
public final class C0906c {
    ...
    private static final ThreadLocal<Stack<StringBuilder>> e = new C0905b();
    ...
    public static URL j(URL url, String str) {
        ...
        if (url2.getRef() != null) {
            StringBuilder sbA = com.github.catvod.spider.merge.C1.a.a(strReplaceFirst, "#");
            sbA.append(url2.getRef());
            strReplaceFirst = sbA.toString();
        }
