...
public final class c implements Iterable<a>, Cloneable {
    ...
    private void h(int i) {
        com.github.catvod.spider.merge.XU.k.c(i >= this.a);
        String[] strArr = this.b;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void y(int i) {
        com.github.catvod.spider.merge.XU.k.b(i >= this.a);
        int i2 = (this.a - i) - 1;
        if (i2 > 0) {
            String[] strArr = this.b;
            int i3 = i + 1;
    ...
    */
    public final int k(com.github.catvod.spider.merge.Mp.E r8) {
        /*
            r7 = this;
            int r0 = r7.a
            r1 = 1
        ...
        L48:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.UY.c.k(com.github.catvod.spider.merge.Mp.E):int");
    }
    ...
    public final void u() {
        for (int i = 0; i < this.a; i++) {
            String[] strArr = this.b;
            strArr[i] = com.github.catvod.spider.merge.Bk.l.c(strArr[i]);
        }
    }
