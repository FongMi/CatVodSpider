 ...
 * @author Qile
 */
public class Yingshiche extends Spider {

    private static String siteUrl = "https://www.weixine.net";
    ...
    public void init(Context context, String extend) throws Exception {
        ...
        ali.init(context, this.extend.get("token").getAsString());
    }
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        for (String link : shareLinks) {
            if (link.contains("alipan.com") || link.contains("aliyundrive.com")) {
                vod_play.put(ali.detailContentVodPlayFrom(Arrays.asList(link)), ali.detailContentVodPlayUrl(Arrays.asList(link)));
            }
        }
