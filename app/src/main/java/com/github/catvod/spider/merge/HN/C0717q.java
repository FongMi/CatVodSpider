...
/* JADX INFO: renamed from: com.github.catvod.spider.merge.HN.q, reason: case insensitive filesystem */
...
final class C0717q {
    ...
    C0717q(t tVar, Calendar calendar) {
        this.c = tVar;
        this.a = calendar;
    }
    ...
    final C0716p a() {
        ...
        if ((cCharAt >= 'A' && cCharAt <= 'Z') || (cCharAt >= 'a' && cCharAt <= 'z')) {
            ...
            int i3 = this.b - i;
            return new C0716p(t.b(this.c, cCharAt, i3, this.a), i3);
        }
        ...
        if (z) {
            throw new IllegalArgumentException(ZrJ.d("2C2D3F283A28102D2A392D2159323E223C20"));
        }
        String string = sb.toString();
        return new C0716p(new C0711k(string), string.length());
    }
}
