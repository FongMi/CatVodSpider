...
public final class b extends com.github.catvod.spider.merge.q1.c {
    ...
    public final String g(String str) throws i {
        int i = m.c;
        m.a(Pattern.compile("^https?://(www\\.|m\\.)?soundcloud.com/[0-9a-z_-]+/sets/[0-9a-z_-]+/?([#?].*)?$"), str);
        try {
            return com.github.catvod.spider.merge.C1.b.e(str);
        } catch (Exception e) {
            throw new i("Could not get id of url: " + str + " " + e.getMessage(), e);
        }
    }

    @Override // com.github.catvod.spider.merge.b.AbstractC0901a
    public final boolean l(String str) {
        return k.b("^https?://(www\\.|m\\.)?soundcloud.com/[0-9a-z_-]+/sets/[0-9a-z_-]+/?([#?].*)?$", str.toLowerCase());
    }

    @Override // com.github.catvod.spider.merge.q1.c
    public final String q(String str, List list) throws i {
        try {
            return com.github.catvod.spider.merge.C1.b.f("https://api.soundcloud.com/playlists/" + str);
        } catch (Exception e) {
