...
public class SP360 extends Spider {
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> map) {
        ...
        try {
            ...
            JSONObject jSONObject = new JSONObject(com.github.catvod.spider.merge.k0.StringUtils.d(str6, a())).getJSONObject("data");
    ...
    public String detailContent(List<String> list) {
        ...
        try {
            ...
            JSONObject jSONObject5 = new JSONObject(com.github.catvod.spider.merge.k0.StringUtils.d(str4, a())).getJSONObject("data");
            ...
            if (jSONObjectOptJSONObject2 == null) {
                ...
                while (it2.hasNext()) {
                    ...
                    String str8 = str5;
                    JSONObject jSONObjectOptJSONObject4 = new JSONObject(com.github.catvod.spider.merge.k0.StringUtils.d(string, a())).getJSONObject(str3).optJSONObject(str8);
                    ...
                    if (i7 >= jSONArray2.length()) {
                        ...
                        while (i10 < i7) {
                            ...
                            JSONObject jSONObjectOptJSONObject5 = new JSONObject(com.github.catvod.spider.merge.k0.StringUtils.d(String.format("%s?cat=%s&id=%s&start=%s&end=%s&site=%s", "https://api.web.360kan.com/v1/detail", strArrSplit[0], strArrSplit[1], Integer.valueOf(i10), Integer.valueOf(i11), str7), a())).optJSONObject(str3);
    ...
    public String homeVideoContent() {
        JSONObject jSONObject = new JSONObject();
        try {
            String strD = com.github.catvod.spider.merge.k0.StringUtils.d("https://api.web.360kan.com/v1/rank?cat=1", new HashMap());
    ...
    public String searchContent(String str, boolean z) {
        ...
        JSONObject jSONObject = new JSONObject();
        try {
            JSONObject jSONObjectOptJSONObject2 = new JSONObject(com.github.catvod.spider.merge.k0.StringUtils.d(String.format("https://api.so.360kan.com/index?force_v=1&kw=%s&from=&pageno=1&v_ap=1&tab=all", str), a())).optJSONObject("data");
