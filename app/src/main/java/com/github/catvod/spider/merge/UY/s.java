...
public abstract class s implements Cloneable {
    ...
    protected void C(s sVar) {
        com.github.catvod.spider.merge.XU.k.c(sVar.a == this);
        int i = sVar.b;
        m().remove(i);
        A(i);
        sVar.a = null;
    ...
    public final void D(s sVar) {
        ...
        s sVar2 = this.a;
        sVar2.getClass();
        com.github.catvod.spider.merge.XU.k.c(this.a == sVar2);
        s sVar3 = sVar.a;
        if (sVar3 != null) {
            sVar3.C(sVar);
        }
    ...
    public String a(String str) {
        ...
        return (o() && d().o(str)) ? com.github.catvod.spider.merge.XU.n.i(e(), d().m(str)) : "";
    }

    protected final void b(int i, s... sVarArr) {
        boolean z;
        com.github.catvod.spider.merge.XU.k.g(sVarArr);
        if (sVarArr.length == 0) {
            return;
        }
        List<s> listM = m();
        ...
        for (s sVar : sVarArr) {
            if (sVar == null) {
                throw new com.github.catvod.spider.merge.XU.l(ZrJ.d("3831392C316514363839682B16376B2E272B0D2222236824173A6B233D291563242F22201A3738"));
            }
        }
        for (s sVar2 : sVarArr) {
            sVar2.getClass();
    ...
    public String c(String str) {
        ...
        String strM = d().m(str);
        return strM.length() > 0 ? strM : str.startsWith(ZrJ.d("18213877")) ? a(str.substring(4)) : "";
    }
    ...
    public final boolean n(String str) {
        ...
        if (str.startsWith(ZrJ.d("18213877"))) {
    ...
    protected final void q(Appendable appendable, int i, g gVar) {
        appendable.append('\n').append(com.github.catvod.spider.merge.XU.n.g(gVar.e() * i, gVar.f()));
    }
    ...
    protected final void u(Appendable appendable) {
        ...
        com.github.catvod.spider.merge.XI.p.b(new r(appendable, hVarX.A0()), this);
    }
