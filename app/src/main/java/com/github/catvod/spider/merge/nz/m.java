...
public final class m {
    ...
    public static boolean d(String str) {
        try {
            ...
            String[] strArr = {"iqiyi.com", "v.qq.com", "youku.com", "le.com", "tudou.com", "mgtv.com", "sohu.com", "acfun.cn", "bilibili.com", "baofeng.com", "pptv.com", "1905.com"};
            for (int i = 0; i < 12; i++) {
    ...
    public static JSONObject e(String str, String str2) throws JSONException {
        ...
        if (string.startsWith("//")) {
            string = com.github.catvod.spider.merge.dp.n.a("https:", string);
        }
