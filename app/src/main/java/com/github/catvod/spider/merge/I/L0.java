...
public final class L0 {
    ...
    private List<com.github.catvod.spider.merge.Z.b> b(String str, com.github.catvod.spider.merge.K.VodItem iVar) {
    ...
    private String h(String str, String str2, boolean z) {
        ...
        if (z) {
            mapD = new HashMap<>();
            StringBuilder sbB = t0.b("Authorization ");
            sbB.append(this.a);
    ...
    public final com.github.catvod.spider.merge.K.VodItem e(String str, String str2, String str3) {
        ...
        try {
            ...
            for (com.github.catvod.spider.merge.Z.b bVar : (ArrayList) listB) {
                if (com.github.catvod.spider.merge.P0.e.d(com.github.catvod.spider.merge.i0.m.m(bVar.a()))) {
                    arrayList.add(bVar);
                }
            }
    ...
    public final String g(String[] strArr, boolean z) {
        ...
        for (String str2 : strArr) {
            if (str2.contains("@@@")) {
                ...
                hVar.b(str3);
                com.github.catvod.spider.merge.K.h hVarA = hVar.a(str4);
                hVarA.c(str5);
                arrayList.add(hVarA);
            }
        }
