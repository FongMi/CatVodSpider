...
public final class k implements com.github.catvod.spider.merge.Wb.a {
    ...
    public final com.github.catvod.spider.merge.Wb.f a(C0724g c0724g) {
        ...
        for (com.github.catvod.spider.merge.UY.m mVar : c0724g) {
            ...
            while (it.hasNext()) {
                C0724g c0724gD = p.d(it.next());
                if (c0724gD != null) {
                    linkedList.addAll(c0724gD);
                }
            }
            C0724g c0724gD2 = p.d(mVar);
            if (c0724gD2 != null) {
                linkedList.addAll(c0724gD2);
            }
        }
    ...
    public final String name() {
        return ZrJ.d("09312E2E2D21102D2C");
    }
}
