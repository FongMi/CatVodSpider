...
public final class m extends b {
    private int a;
    private com.github.catvod.spider.merge.S.l b;
    private boolean c;
    private short d;
    private int e;
    private int[] f;
    ...
    public m(com.github.catvod.spider.merge.S.l lVar) {
        this.b = lVar;
        this.c = false;
        this.i = null;
        this.f = new int[4];
    ...
    public m(com.github.catvod.spider.merge.S.l lVar, boolean z, b bVar) {
        this.b = lVar;
        this.c = z;
        this.i = bVar;
        this.f = new int[4];
