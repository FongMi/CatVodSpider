...
public final class u extends com.github.catvod.spider.merge.y.y {
    public u(com.github.catvod.spider.merge.y.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.C.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).s(this) : dVar.l(this);
    }
