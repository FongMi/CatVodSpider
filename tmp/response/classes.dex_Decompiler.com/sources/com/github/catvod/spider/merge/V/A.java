...
public final class A extends com.github.catvod.spider.merge.y.y {
    public InterfaceC0250E g;

    public A(com.github.catvod.spider.merge.y.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.C.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).d(this) : dVar.l(this);
    }
