...
public final class i extends com.github.catvod.spider.merge.y.y {
    public i(com.github.catvod.spider.merge.y.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.C.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).g(this) : dVar.l(this);
    }
