...
public final class f extends com.github.catvod.spider.merge.y.y {
    public f(com.github.catvod.spider.merge.y.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.C.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).h(this) : dVar.l(this);
    }
