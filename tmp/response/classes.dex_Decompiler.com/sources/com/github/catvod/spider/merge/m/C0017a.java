...
public final class C0017a {
    ...
    public C0017a(Reader reader, int i) {
        com.github.catvod.spider.merge.J.c.c(reader.markSupported());
        this.b = reader;
    ...
    private void b() {
        ...
        try {
            ...
            if (i4 > 0) {
                ...
                com.github.catvod.spider.merge.J.c.c(z);
                this.c = i4;
                this.f += i;
                this.e = i2;
                if (this.g != -1) {
    ...
    */
    private static java.lang.String c(char[] r9, java.lang.String[] r10, int r11, int r12) {
        ...
        L47:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.M.C0017a.c(char[], java.lang.String[], int, int):java.lang.String");
    }
    ...
    final void M() {
        int i = this.g;
        if (i == -1) {
            throw new com.github.catvod.spider.merge.I.b(new IOException(oZP.d("380E052A4C3C1B19162D0531")));
        }
        this.e = i;
        this.g = -1;
    }
    ...
    final void P() {
        int i = this.e;
        if (i < 1) {
            throw new com.github.catvod.spider.merge.I.b(new IOException(oZP.d("223B317B4C1B1A4F15340A33101D572D0933014F032E4C201B0C182F1F20180A59")));
        }
        this.e = i - 1;
    }
    ...
    final String v() {
        return A(this.f + this.e) + oZP.d("4F") + e(this.f + this.e);
    }
