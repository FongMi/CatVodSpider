...
public class c<T> implements Set<T> {
    ...
    */
    public final boolean containsAll(java.util.Collection<?> r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof com.github.catvod.spider.merge.B.c
            r1 = 0
            if (r0 == 0) goto L2c
            com.github.catvod.spider.merge.B.c r8 = (com.github.catvod.spider.merge.B.c) r8
            T[][] r8 = r8.b
            int r0 = r8.length
            r2 = 0
        Lb:
        ...
        L45:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.B.c.containsAll(java.util.Collection):boolean");
    }
