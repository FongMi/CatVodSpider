...
public class PanWebShareQY extends Pan {
    private String f;
    ...
    private String j(String str) {
        C0274g c0274gO0 = F.d(C0378c.n(this.f + "/vodsearch/" + URLEncoder.encode(str) + "-------------.html", g())).o0(".module-search-item");
        ...
        for (m mVar : c0274gO0) {
            ...
            if (!strA3.toLowerCase().startsWith("http")) {
                strA3 = this.f + strA3;
            }
    ...
    public String detailContent(List<String> list) {
        ...
        while (true) {
            ...
            if (Pan.f6a.matcher((CharSequence) arrayList6.get(i)).find() && arrayList.size() < 2) {
                arrayList.add((String) arrayList6.get(i));
            }
            if (Pan.b.matcher((CharSequence) arrayList6.get(i)).find() && arrayList2.size() < 2) {
                arrayList2.add((String) arrayList6.get(i));
            }
            if (Pan.c.matcher((CharSequence) arrayList6.get(i)).find() && arrayList2.size() < 2) {
                arrayList3.add((String) arrayList6.get(i));
            }
            if (Pan.d.matcher((CharSequence) arrayList6.get(i)).find() && arrayList3.size() < 2) {
                arrayList4.add((String) arrayList6.get(i));
            }
            if (Pan.e.matcher((CharSequence) arrayList6.get(i)).find() && arrayList2.size() < 2) {
                arrayList5.add((String) arrayList6.get(i));
            }
            if (Pan.f.matcher((CharSequence) arrayList6.get(i)).find() && arrayList4.size() < 2) {
                arrayList5.add((String) arrayList6.get(i));
            }
            i++;
        }
        ...
        if (!strC.toLowerCase().startsWith("http")) {
            strC = this.f + strC;
        }
        ...
        String strI = hVarG.o0("div.vod_content > span").i();
    ...
    public String homeContent(boolean z) {
        ...
        for (m mVar : hVarG.o0("ul.grid-items > li > a")) {
            if (mVar.c("href").startsWith("/vod")) {
                if (arrayList.size() >= 7) {
                    break;
                }
                arrayList.add(new C0323a(mVar.c("href").replaceAll("\\D+", ""), mVar.c("title")));
            }
        }
