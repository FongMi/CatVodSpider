...
final class Q {
    ...
    final int[] d(Character ch, boolean z) {
        ...
        if ((ch == null || ch.charValue() != this.a.s()) && !this.a.A(r)) {
            ...
            if (this.a.w("#")) {
                ...
                String strI = zX ? c0123a.i() : c0123a.h();
                if (strI.length() != 0) {
                    this.a.H();
                    if (!this.a.w(";")) {
                        c("missing semicolon");
                ...
                boolean zY = this.a.y(';');
                if (!(com.github.catvod.spider.merge.C0.c0.n.e(strK) || (com.github.catvod.spider.merge.C0.c0.n.f(strK) && zY))) {
                    this.a.F();
                    if (zY) {
                ...
                if (!z || (!this.a.C() && !this.a.B() && !this.a.z('=', '-', '_'))) {
                    ...
                    int iC = com.github.catvod.spider.merge.C0.c0.n.c(strK, this.q);
                    if (iC == 1) {
                        iArr[0] = this.q[0];
                        return iArr;
                    }
                    ...
                    com.github.catvod.spider.merge.C0.N.a.a("Unexpected characters returned for " + strK);
                    throw null;
                }
            }
            this.a.F();
    ...
    final void j(O o) {
        com.github.catvod.spider.merge.C0.N.a.e(this.e);
        this.d = o;
        this.e = true;
        int i = o.a;
        if (i == 2) {
