...
public class b<T> implements Set<T> {
    ...
    public b(com.github.catvod.spider.merge.w.a aVar, int i) {
        this.c = 0;
    ...
    */
    public final boolean containsAll(java.util.Collection<?> r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof com.github.catvod.spider.merge.w.b
            r1 = 0
            if (r0 == 0) goto L2c
            com.github.catvod.spider.merge.w.b r8 = (com.github.catvod.spider.merge.w.b) r8
            T[][] r8 = r8.b
            int r0 = r8.length
            r2 = 0
        Lb:
        ...
        L45:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.w.b.containsAll(java.util.Collection):boolean");
    }
        ...
        for (T[] tArr : this.b) {
            if (tArr != null) {
                for (T t : tArr) {
                    ...
                    iH = com.github.catvod.spider.merge.F.a.h(iH, this.a.F(t));
                }
            }
        }
