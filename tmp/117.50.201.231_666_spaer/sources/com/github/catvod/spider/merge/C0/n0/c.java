package com.github.catvod.spider.merge.C0.n0;

import com.github.catvod.spider.merge.C0.p0.d;
import com.github.catvod.spider.merge.C0.p0.f;
...
public final class c {
    ...
    static final com.github.catvod.spider.merge.C0.W.a c = new com.github.catvod.spider.merge.C0.W.a();
    static boolean d;
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [com.github.catvod.spider.merge.C0.n0.a, org.slf4j.ILoggerFactory] */
    public static a c() {
        if (a == 0) {
    ...
    public static b d(Class<?> cls) {
        ...
        if (d && (clsA = f.a()) != null && (!clsA.isAssignableFrom(cls))) {
            f.b(String.format("Detected logger name mismatch. Given name: \"%s\"; computed name: \"%s\".", bVarA.b(), clsA.getName()));
    ...
    private static void g() {
        ...
        synchronized (dVar) {
            dVar.e();
            for (com.github.catvod.spider.merge.C0.p0.c cVar : (ArrayList) dVar.d()) {
                cVar.g(e(cVar.b()));
            }
        }
        LinkedBlockingQueue linkedBlockingQueueC = b.c();
        int size = linkedBlockingQueueC.size();
        ArrayList<com.github.catvod.spider.merge.C0.o0.c> arrayList = new ArrayList(128);
        int i = 0;
        while (linkedBlockingQueueC.drainTo(arrayList, 128) != 0) {
            int i2 = i;
            for (com.github.catvod.spider.merge.C0.o0.c cVar2 : arrayList) {
                if (cVar2 != null) {
                    com.github.catvod.spider.merge.C0.p0.c cVarA = cVar2.a();
                    String strB = cVarA.b();
                    if (cVarA.e()) {
    ...
    private static void h(Set<URL> set) {
        if (set != null) {
            if (set.size() > 1) {
                StringBuilder sbB = com.github.catvod.spider.merge.C0.d.d.b("Actual binding is of type [");
