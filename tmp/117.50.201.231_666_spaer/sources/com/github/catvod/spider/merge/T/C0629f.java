...
/* JADX INFO: renamed from: com.github.catvod.spider.merge.t.f, reason: case insensitive filesystem */
...
public final class C0629f {
    ...
    /* JADX INFO: renamed from: com.github.catvod.spider.merge.t.f$a */
    public static class a {
        ...
        public final C0629f d() {
            ...
            return new C0629f(this.a, this.b, this.c, this.d);
        }
    }

    C0629f(int i, ByteBuffer byteBuffer, CharBuffer charBuffer, IntBuffer intBuffer) {
        this.a = i;
        this.b = byteBuffer;
        this.c = charBuffer;
        this.d = intBuffer;
