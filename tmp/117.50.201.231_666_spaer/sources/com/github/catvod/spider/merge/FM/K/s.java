...
public abstract class s implements Cloneable {
    ...
    protected void C(s sVar) {
        com.github.catvod.spider.merge.FM.I.c.c(sVar.a == this);
        int i = sVar.b;
        m().remove(i);
        A(i);
        sVar.a = null;
    ...
    public final void D(s sVar) {
        ...
        s sVar2 = this.a;
        sVar2.getClass();
        com.github.catvod.spider.merge.FM.I.c.c(this.a == sVar2);
        s sVar3 = sVar.a;
        if (sVar3 != null) {
            sVar3.C(sVar);
        }
    ...
    public String a(String str) {
        ...
        return (o() && d().o(str)) ? com.github.catvod.spider.merge.FM.J.b.i(e(), d().m(str)) : "";
    }

    protected final void b(int i, s... sVarArr) {
        boolean z;
        com.github.catvod.spider.merge.FM.I.c.g(sVarArr);
        if (sVarArr.length == 0) {
            return;
        }
        List<s> listM = m();
        ...
        for (s sVar : sVarArr) {
            if (sVar == null) {
                throw new com.github.catvod.spider.merge.FM.I.d("Array must not contain any null objects");
            }
        }
        for (s sVar2 : sVarArr) {
            sVar2.getClass();
    ...
    protected final void q(Appendable appendable, int i, g gVar) {
        appendable.append('\n').append(com.github.catvod.spider.merge.FM.J.b.g(gVar.e() * i, gVar.f()));
    }
    ...
    protected final void u(Appendable appendable) {
        ...
        com.github.catvod.spider.merge.FM.E.a.d(new r(appendable, hVarX.A0()), this);
    }
