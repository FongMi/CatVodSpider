...
public final class f extends com.github.catvod.spider.merge.FM.x.y {
    public f(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).p(this) : dVar.g(this);
    }
