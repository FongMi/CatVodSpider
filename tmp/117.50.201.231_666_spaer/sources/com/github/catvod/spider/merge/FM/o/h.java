...
public final class h extends b {
    ...
    public final String c() {
        int i = this.a - this.b;
        if (i >= 5) {
            return com.github.catvod.spider.merge.FM.N.a.t;
        }
        if (i <= -5) {
            return com.github.catvod.spider.merge.FM.N.a.f;
        }
    ...
    */
    public final int f(byte[] r7, int r8) {
        ...
        L5b:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.FM.O.h.f(byte[], int):int");
    }
