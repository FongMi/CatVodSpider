...
public final class A extends com.github.catvod.spider.merge.FM.x.y {
    public InterfaceC0427E g;

    public A(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).w(this) : dVar.g(this);
    }
