...
public final class k extends com.github.catvod.spider.merge.FM.x.y {
    public k(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).u(this) : dVar.g(this);
    }
