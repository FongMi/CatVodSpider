...
public final class m extends com.github.catvod.spider.merge.FM.x.y {
    public m(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).B(this) : dVar.g(this);
    }
