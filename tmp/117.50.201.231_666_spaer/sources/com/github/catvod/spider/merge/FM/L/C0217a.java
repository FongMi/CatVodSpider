...
public final class C0217a {
    ...
    public C0217a(Reader reader, int i) {
        com.github.catvod.spider.merge.FM.I.c.c(reader.markSupported());
        this.b = reader;
    ...
    private void b() {
        ...
        try {
            ...
            if (i4 > 0) {
                ...
                com.github.catvod.spider.merge.FM.I.c.c(z);
                this.c = i4;
                this.f += i;
                this.e = i2;
                if (this.g != -1) {
    ...
    */
    private static java.lang.String c(char[] r9, java.lang.String[] r10, int r11, int r12) {
        ...
        L47:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.catvod.spider.merge.FM.L.C0217a.c(char[], java.lang.String[], int, int):java.lang.String");
    }
    ...
    final void M() {
        int i = this.g;
        if (i == -1) {
            throw new com.github.catvod.spider.merge.FM.H.b(new IOException("Mark invalid"));
        }
        this.e = i;
        this.g = -1;
    }
    ...
    final void P() {
        int i = this.e;
        if (i < 1) {
            throw new com.github.catvod.spider.merge.FM.H.b(new IOException("WTF: No buffer left to unconsume."));
        }
        this.e = i - 1;
    }
