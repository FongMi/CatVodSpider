...
public final class m implements com.github.catvod.spider.merge.L.c {
    ...
    public final com.github.catvod.spider.merge.L.f a(com.github.catvod.spider.merge.L.e eVar, List<com.github.catvod.spider.merge.L.f> list) {
        ...
        if (!com.github.catvod.spider.merge.y.f.c(strG)) {
            strG = (com.github.catvod.spider.merge.y.f.c(strG2) || (iLastIndexOf = strG.lastIndexOf(strG2)) == -1 || iLastIndexOf == strG.length() - strG2.length()) ? "" : strG.substring(strG2.length() + iLastIndexOf);
        }
