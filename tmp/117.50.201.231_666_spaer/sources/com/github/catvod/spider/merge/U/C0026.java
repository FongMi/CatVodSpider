...
public class C0026 {
    ...
    public static String m80(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
