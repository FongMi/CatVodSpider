...
public final class u extends com.github.catvod.spider.merge.FM.x.y {
    public u(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).o(this) : dVar.g(this);
    }
