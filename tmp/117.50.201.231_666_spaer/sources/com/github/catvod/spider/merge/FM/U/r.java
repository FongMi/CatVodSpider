...
public final class r extends com.github.catvod.spider.merge.FM.x.y {
    public r(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).z(this) : dVar.g(this);
    }
