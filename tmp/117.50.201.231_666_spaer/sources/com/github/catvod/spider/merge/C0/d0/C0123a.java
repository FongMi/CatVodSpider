...
/* JADX INFO: renamed from: com.github.catvod.spider.merge.C0.d0.a, reason: case insensitive filesystem */
...
public final class C0123a {
    ...
    public C0123a(Reader reader, int i) {
        com.github.catvod.spider.merge.C0.N.a.f(reader.markSupported());
        this.b = reader;
    ...
    private void b() {
        ...
        try {
            ...
            this.b.reset();
            if (i4 > 0) {
                com.github.catvod.spider.merge.C0.N.a.f(jSkip == j);
                this.c = i4;
                this.f += i;
                this.e = i2;
                if (this.g != -1) {
    ...
    final void F() {
        int i = this.g;
        if (i == -1) {
            throw new com.github.catvod.spider.merge.C0.Z.b(new IOException("Mark invalid"));
        }
        this.e = i;
        this.g = -1;
    }
    ...
    final void G() {
        int i = this.e;
        if (i < 1) {
            throw new com.github.catvod.spider.merge.C0.Z.b(new IOException("WTF: No buffer left to unconsume."));
        }
        this.e = i - 1;
    }
