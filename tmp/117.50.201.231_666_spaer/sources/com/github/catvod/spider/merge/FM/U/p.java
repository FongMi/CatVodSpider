...
public final class p extends com.github.catvod.spider.merge.FM.x.y {
    public p(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).j(this) : dVar.g(this);
    }
