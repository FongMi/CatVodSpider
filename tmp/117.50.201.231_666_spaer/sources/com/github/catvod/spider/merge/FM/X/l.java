...
public final class l implements com.github.catvod.spider.merge.FM.V.c {
    ...
    public final com.github.catvod.spider.merge.FM.V.f a(com.github.catvod.spider.merge.FM.V.e eVar, List<com.github.catvod.spider.merge.FM.V.f> list) {
        ...
        if (!com.github.catvod.spider.merge.FM.C.h.c(strG)) {
            strG = (strG2 == null || (iIndexOf = strG.indexOf(strG2)) == -1) ? "" : strG.substring(strG2.length() + iIndexOf);
        }
