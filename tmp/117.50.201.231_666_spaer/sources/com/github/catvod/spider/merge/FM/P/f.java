...
public final class f {
    ...
    public static void c(OkHttpClient okHttpClient, String str, Map map, AbstractC0401c abstractC0401c) {
        new d(a, str, (Map<String, String>) null, (Map<String, String>) map, abstractC0401c).a(okHttpClient);
    }

    public static void d(OkHttpClient okHttpClient, String str, Map<String, String> map, Map<String, String> map2, AbstractC0401c abstractC0401c) {
        new d(b, str, map, map2, abstractC0401c).a(okHttpClient);
    }

    public static void e(OkHttpClient okHttpClient, String str, String str2, Map<String, String> map, AbstractC0401c abstractC0401c) {
        new d(b, str, str2, map, abstractC0401c).a(okHttpClient);
    }
