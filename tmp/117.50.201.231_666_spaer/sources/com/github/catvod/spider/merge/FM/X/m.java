...
public final class m implements com.github.catvod.spider.merge.FM.V.c {
    ...
    public final com.github.catvod.spider.merge.FM.V.f a(com.github.catvod.spider.merge.FM.V.e eVar, List<com.github.catvod.spider.merge.FM.V.f> list) {
        ...
        if (!com.github.catvod.spider.merge.FM.C.h.c(strG)) {
            strG = (com.github.catvod.spider.merge.FM.C.h.c(strG2) || (iLastIndexOf = strG.lastIndexOf(strG2)) == -1 || iLastIndexOf == strG.length() - strG2.length()) ? "" : strG.substring(strG2.length() + iLastIndexOf);
        }
