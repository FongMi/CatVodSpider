...
public final class x extends com.github.catvod.spider.merge.FM.x.y {
    public InterfaceC0427E g;

    public x(com.github.catvod.spider.merge.FM.x.y yVar, int i) {
        super(yVar, i);
    }
    ...
    public final <T> T b(com.github.catvod.spider.merge.FM.B.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).D(this) : dVar.g(this);
    }
