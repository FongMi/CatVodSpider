...
public class Wogg extends Pan {
    ...
    private String j(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        sb.append(this.f);
        C0274g c0274gO0 = l.g(C0378c.n(v.a("/index.php/vodsearch/%s----------%s---.html", new Object[]{URLEncoder.encode(str), str2}, sb), g())).o0(".module-search-item");
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> map) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(this.f);
        List<C0332j> vodList = parseVodList(l.g(C0378c.n(v.a("/vodshow/%s-%s-%s-%s-----%s---%s.html", new Object[]{str, str3, str5, str6, str2, str4}, sb), g())).o0(".module-item"));
    ...
    public String detailContent(List<String> list) {
        ...
        while (true) {
            ...
            if (Pan.f.matcher((CharSequence) arrayList3.get(i)).find()) {
